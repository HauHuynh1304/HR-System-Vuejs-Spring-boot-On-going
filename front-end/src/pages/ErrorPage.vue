    ...
    <div class="container">
      <div class="left-section">
        <div class="inner-content">
          <h1 class="heading">{{ isForbidentArea ? "403" : "404" }}</h1>
          <p class="subheading">
            {{
              isForbidentArea
                ? "Looks like you can not access to the page you were looking for."
...
export default {
  data() {
    return {
      isForbidentArea: null,
    };
  },
  created() {
    if (this.$route.path.includes("forbident")) {
      this.isForbidentArea = true;
    }
  },
};
</script>
