<template>
  <nav
    class="navbar main-nav flex-row align-items-md-center"
    type=""
    effect="light"
    expand
  >
    <a
      slot="brand"
      class="navbar-brand mr-0 mr-md-2 d-inline d-md-none"
      href="/"
    ...
    <ul class="navbar-nav flex-row mr-auto d-none d-md-flex">
      <li class="nav-item">
        <a slot="brand" class="nav-link brand" href="/" aria-label="Bootstrap">
          Vue White Dashboard Laravel
        </a>
      </li>
      <li class="nav-item">
